...
function changeColor() {
    ...
    if (document.getElementsByTagName('html')[0].getAttribute('data-theme') == 'dark') {
        ...
        if (document.getElementsByClassName("site-name")) {
            var siteNameElements = document.getElementsByClassName("site-name");
            for (var i = 0; i < siteNameElements.length; i++) {
                siteNameElements[i].style.textShadow = "#1e1e1ee0 1px 1px 1px";
            }
        }
        if (document.getElementById("site-title"))
